...
extern "C" {
    ...
    void loadIOSContacts()
    {
        ...
        if (status == kABAuthorizationStatusDenied) {
            ...
            [[[UIAlertView alloc] initWithTitle:nil message:@"You previously blocked access to your contacts so your friend's can't be synced. You can update this in this app's page in the Settings app." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
        ...
        if (error) {
            ...
            if (addressBook) 
				CFRelease(addressBook);
			UnitySendMessage("ContactsListMessageReceiver", "OnInitializeFail","Couldn't get your contacts");
            return;
        }
            ...
            ABAddressBookRequestAccessWithCompletion(addressBook, ^(bool granted, CFErrorRef error) {
                ...
                else
                {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        [[[UIAlertView alloc] initWithTitle:nil message:@"If you want to sync your friends, visit this app's page in the Settings app." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
                    });
